...
sequenceDiagram
    ...
    Client->>+PaymentService: CreatePayment
    Note right of PaymentService: CreatePaymentRequest
    PaymentService->>-Client: CreatePaymentResponse
    Client->>+PaymentService: GetPayment
    Note right of PaymentService: GetPaymentRequest
    PaymentService->>-Client: GetPaymentResponse
    Client->>+PaymentService: CancelPayment
    Note right of PaymentService: CancelPaymentRequest
    PaymentService->>-Client: CancelPaymentResponse
    Client->>+PaymentService: RefundPayment
    Note right of PaymentService: RefundPaymentRequest
    PaymentService->>-Client: RefundPaymentResponse
    Client->>+PaymentService: ListPayments
    Note right of PaymentService: ListPaymentsRequest
    PaymentService->>-Client: ListPaymentsResponse
    Client->>+PaymentService: ProcessBatch
    Note right of PaymentService: ProcessBatchRequest
    PaymentService->>-Client: Stream of BatchProcessResult
    Client->>+PaymentService: SubscribeToPaymentEvents
    Note right of PaymentService: SubscribeRequest
    PaymentService->>-Client: Stream of PaymentEvent
```
...
classDiagram
    ...
    Payment "1" --> "1" Metadata
    Payment "1" --> "1" Money
    Payment "1" --> "1" PaymentMethod
    Payment "1" --> "1" PaymentStatus
    Payment "1" --> "1" TransactionType
    Payment "1" --> "1" PayerInfo
    Payment "1" --> "1" PayeeInfo
    Payment "1" --> "1" CardPaymentDetails
    Payment "1" --> "1" BankTransferDetails
    Payment "1" --> "1" WalletPaymentDetails
    Payment "1" --> "1" CryptoPaymentDetails
    Payment "1" --> "1" CaptureDetails
    ...
    BatchProcessResult "1" --> "1" Payment
    BatchProcessResult "1" --> "1" Error
    ...
    CreatePaymentRequest "1" --> "1" Money
    CreatePaymentRequest "1" --> "1" PaymentMethod
    CreatePaymentRequest "1" --> "1" PayerInfo
    CreatePaymentRequest "1" --> "1" CardSource
...
erDiagram
    ...
    Payment ||--|| Metadata : has
    Payment ||--|| Money : has
    Payment ||--|| PaymentMethod : has
    Payment ||--|| PaymentStatus : has
    Payment ||--|| TransactionType : has
    Payment ||--|| PayerInfo : has
    Payment ||--|| PayeeInfo : has
    Payment ||--|| CardPaymentDetails : has
    Payment ||--|| BankTransferDetails : has
    Payment ||--|| WalletPaymentDetails : has
    Payment ||--|| CryptoPaymentDetails : has
    Payment ||--|| CaptureDetails : has
    Payment ||--o{ RefundDetails : has
    ...
    BatchProcessResult ||--|| Payment : has
    BatchProcessResult ||--|| Error : has
    BankTransferDetails {
        string account_holder
        string account_number_masked
        string routing_number
    ...
    CreatePaymentRequest ||--|| Money : has
    CreatePaymentRequest ||--|| PaymentMethod : has
    CreatePaymentRequest ||--|| PayerInfo : has
    CreatePaymentRequest ||--|| CardSource : has
...
import { ProtoGrpcType } from './payments/payments';
import { PaymentServiceClient } from './payments.v1/PaymentService';
...
// Create client
const client: PaymentServiceClient = new proto.payments.v1.PaymentService(
    'localhost:50051',
...
client.CreatePayment(request, (error: grpc.ServiceError | null, response?: any) => {
    if (error) {
